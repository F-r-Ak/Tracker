                ...
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex items-center">
                            ...
                            <label for="option1" class="leading-none mr-2">Chicago</label>
                        </div>
                        <div class="flex items-center">
                            <p-radiobutton id="option2" name="option" value="Los Angeles" [(ngModel)]="radioValue" />
                            <label for="option2" class="leading-none mr-2">Los Angeles</label>
                        </div>
                        <div class="flex items-center">
                            <p-radiobutton id="option3" name="option" value="New York" [(ngModel)]="radioValue" />
                            <label for="option3" class="leading-none mr-2">New York</label>
                        </div>
                    </div>
