...
@Component({
    selector: 'app-add-edit-governate-geo-point',
    standalone: true,
    imports: [CardModule, FormsModule, ReactiveFormsModule, SubmitButtonsComponent, PrimeInputTextComponent],
    templateUrl: './add-edit-governate-geo-point.component.html',
    styleUrl: './add-edit-governate-geo-point.component.scss'
})
export class AddEditGovernateGeoPoint extends BaseEditComponent implements OnInit {
