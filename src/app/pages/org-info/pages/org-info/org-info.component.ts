...
export class OrgInfoComponent extends BaseListComponent {
    ...
    initializeTableOptions() {
        this.tableOptions = {
            ...
            permissions: {
                componentName: 'SONO-TRACKER-ORGANIZATION-INFO',
                allowAll: true,
                listOfPermissions: []
            },
            bodyOptions: {
                filter: {
                    organizationTypeId: this.organizationEnum.GovernmentCompany
                }
            },
            responsiveDisplayedProperties: ['code', 'nameAr', 'nameEn', 'address']
        };
    }
