...
@Component({
    selector: 'app-org-operator-companies',
    imports: [RouterModule, FormsModule, ReactiveFormsModule, CardModule, PrimeDataTableComponent, PrimeTitleToolBarComponent],
    templateUrl: './org-operator-companies.component.html',
    styleUrl: './org-operator-companies.component.scss'
})
export class OrgOperatorCompaniesComponent extends BaseListComponent {
    ...
    initializeTableOptions() {
        this.tableOptions = {
            ...
            bodyOptions: {
                filter: {
                    organizationTypeId: this.organizationEnum.OperatingCompany
                }
            },
            responsiveDisplayedProperties: ['code', 'licenseNumber', 'nameAr', 'nameEn', 'address', 'mobile']
        };
    }
        ...
        return [
            {
                ...
                color: 'text-middle',
                isEdit: true,
                route: '/pages/org-operator-companies/edit/',
                allowAll: true
            },
            {
                name: 'DELETE',
