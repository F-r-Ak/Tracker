...
@Component({
    selector: 'app-add-edit-org-owner-company',
    standalone: true,
    ...
    templateUrl: './add-edit-org-owner-company.component.html',
    styleUrl: './add-edit-org-owner-company.component.scss'
})
export class AddEditOrgOwnerCompanyComponent extends BaseEditComponent implements OnInit {
    ...
    initFormGroup() {
        this.form = this.fb.group({
            ...
            organizationTypeId: [this.organizationEnum.OwnerCompany, Validators.required],
